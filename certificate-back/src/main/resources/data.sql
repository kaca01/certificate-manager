...
insert into restapi.certificate (type, valid_from, valid_to, subject_id, is_withdrawn, withdrawn_reason, serial_number) values (0, '2023-05-01T11:00:00.000', '2024-05-01T00:00:00.000', 4, false, '', '4604902006381533243');

insert into restapi.certificate_request (date, status, issuer_id, type, subject_id, refusal_reason) values ('2022-02-18T14:18:24.893', 1, 1, 1, 2, '');
insert into restapi.certificate (type, valid_from, valid_to, subject_id, is_withdrawn, withdrawn_reason, serial_number) values (1, '2023-05-01T00:00:00.000', '2024-05-01T00:00:00.000', 2, false, '', '5440992161912455484');

insert into restapi.certificate_request (date, status, issuer_id, type, subject_id, refusal_reason) values ('2022-02-18T14:18:24.893', 1, 1, 1, 1, '');
insert into restapi.certificate (type, valid_from, valid_to, subject_id, is_withdrawn, withdrawn_reason, serial_number) values (1, '2023-05-01T00:00:00.000', '2024-05-01T00:00:00.000', 1, false, '', '-3360052214249816916');

insert into restapi.certificate_request (date, status, issuer_id, type, subject_id, refusal_reason) values ('2022-02-18T14:18:24.893', 1, 3, 1, 3, '');
insert into restapi.certificate (type, valid_from, valid_to, subject_id, is_withdrawn, withdrawn_reason, serial_number) values (1, '2023-05-01T00:00:00.000', '2024-05-01T00:00:00.000', 3, false, '', '-1347043084476417129');

insert into restapi.certificate_request (date, status, issuer_id, type, subject_id, refusal_reason) values ('2022-02-18T14:18:24.893', 1, 3, 2, 4, '');
insert into restapi.certificate (type, valid_from, valid_to, subject_id, is_withdrawn, withdrawn_reason, serial_number) values (2, '2023-05-01T00:00:00.000', '2024-05-01T00:00:00.000', 4, false, '', '-3750336939555358699');
